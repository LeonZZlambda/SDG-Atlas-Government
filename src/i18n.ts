...
const resources = {
  'pt-BR': {
    translation: {
      ...
      selection_random_btn: 'Sorteio Aleatório Rápido',
      selection_clear_btn: 'Limpar Seleção',
      selection_all_btn: 'Selecionar Todos',
      selection_next_shuffler: 'Ir para o Sorteador',
      ...
      shuffler_subtitle: 'Realize um sorteio dinâmico para gerar cenários aleatórios estruturados de planejamento cívico.',
